			...
			<div class="col-12 alert alert-info border border-primary">
				...
				<fieldset>
					<legend>Formulario de Ingreso</legend>
						<form name="login" method="post" action="http://localhost/web/app/Http/Controllers/Auth/AuthController.php">
							<p>
							...
							<p>
								...
								<input type="submit" name="btn-login" class="btn btn-outline-success" value="Ingresar">
